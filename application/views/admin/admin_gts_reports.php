...
<li><h4>OPTIONS:</h4></li>
<li><button class="btn btn-submit btn-lg" onclick="$('body').print({noPrintSelector: ' .avoid-this'});"><span class="glyphicon glyphicon-print"></span>&nbsp; Generate Report</button></li>
</ul>
<ul style="list-style-type:none">
<li><a href="<?php echo base_url().'admin/report'; ?>" class="print-link avoid-this" ><button class="print-link avoid-this btn btn-submit btn-lg"><span class="glyphicon glyphicon-triangle-left"></span>&nbsp;Go Back</button></a></li>
</ul>
</div>
...
<br><center><div style="margin:auto;">
	<div id="mdratio" class="rleft" ></div>
	<div id="lof" class="rright" ></div>
	<hr style="border:solid 1px">
</div></center>
...
<center><hr style="border:solid 1px">
...
<center><div style="margin-bottom:500px;">
...
<center><div style="margin: auto; width: 100%; text-align:center">
	<hr style="border:solid 1px">
	<div id="mcourse" style="float:none; border:none; width:100%"></div>
	
	<div id="dcourse" style="margin-top: 650px; float:none; border-top: solid black 2px; width:100%"></div>
</div></center><br>
...
<script type="text/javascript">
  window.onload = function () {
	...
	var chart14 = new CanvasJS.Chart("mdratio",
    {
      title:{
        text: "Masters Doctorate Ratio",
		fontSize:30,
      },
      animationEnabled: false,
      legend: {
	...
	var chart15 = new CanvasJS.Chart("lof",
    {
      title:{
        text: "Line of Work",
		fontSize:30,
	...
	var chart16 = new CanvasJS.Chart("mcourse",
    {
      title:{
        text: "Masters Course",
		fontSize:30,
      ...
      legend: {
        verticalAlign: "center",
        horizontalAlign: "right", fontSize:16, fontFamily: "Arial"
      },
      ...
      {        
        ...
        dataPoints: [
		<?php if(!empty($mcourse)) {
			foreach ($mcourse as $row1) {
				echo '{y: '.$row1->Total.', name: "'.$row1->mdegree.' - #percent%({y})", },';				
	...
	var chart17 = new CanvasJS.Chart("dcourse",
    {
      title:{
      ...
      {        
        ...
        dataPoints: [
		<?php if(!empty($dcourse)) {
			foreach ($dcourse as $row1) {
				echo '{y: '.$row1->Total.', name: "'.$row1->ddegree.' - #percent%({y})", },';				
