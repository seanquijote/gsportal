...
<head>
	...
	<?php echo meta('description','Graduate School Portal');
	$meta = array(
	...
	<title><?php echo isset($title) ? $title : 'Graduate School Portal' ; ?></title>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand"  style="text-align:right;">
                <a href="#top" style="padding-right:10px;" onclick=$(#menu-close).click();><strong>GS Portal</strong></a>
            </li>
            <li style="text-align:right; ">
                <a href="<?php echo base_url();?>" style="padding-right:10px;"  onclick=$("#menu-close").click();>Back to Homepage <i class="fa fa-home" aria-hidden="true"></i></a>
            </li>
        </ul>
    </nav>
<!--
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand">
                <a href="#top" onclick=$("#menu-close").click();>GS Portal</a>
            </li>
            <li>
...
-->
	...
	<header id="top" class="header">
        <div class="text-vertical-center">
            <h1 style="color:#f1f1f1">Graduate School Portal</h1>
	...
	<div class="panel panel-default" style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); background-color:#f3f3f3 opacity:0.8;">
	 ...
	 <!-- Footer -->
    <footer id="contact" style="background:#f1f1f1">
        <div class="container">
            <div class="row">
