								...
								if($row->userstatus != 'disabled') {
									if($row->nfStatus != 'reported') {
										if($row2->subscription == 'no') {
											...
											//--------FOLLOW POST BUTTON
											echo '<li>&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-plus"></i> <input type="submit" style="background:none; border:0px; padding:5px;" name="uf" value="Follow post"></li>';
											...
											echo '<li>&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-remove"></i> <input type="submit" style="background:none; border:0px;padding:5px;" name="uf" value="Unfollow post"></li>';
