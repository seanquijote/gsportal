                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">';
                                                ...
                                                echo '<div class="form-group has-feedback">
                                                 ...
                                                 <div class="col-xs-6">
                                                 <label for="startdate">Date of Starting Work:</label>';
                                                 echo '<input id="startdate" name="empStartDate" type="date" value="'.$wrow->empStartDate.'" class="form-control compatibleDate" placeholder="yyyy/mm/dd" required><i class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right:20px;"></i>';
                                                 echo '<span class="help-block pull-right" style="font-size:12px;">Date format: YYYY-MM-DD</span>';
                                                 echo '</div>';
                                  
                                                echo '<div class="col-xs-6">
                                                  <label for="enddate">Date of Resignation:</label>';
                                                  echo '<input id="enddate" name="empEndDate" type="date" value="'.$wrow->empEndDate.'" class="form-control compatibleDate" placeholder="yyyy/mm/dd" required><i class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right:20px;"></i>';
                                                 echo '<span class="help-block pull-right" style="font-size:12px;">Date format: YYYY-MM-DD</span>';
                                                echo '</div>
                                                      </div>
                                                      <br>
