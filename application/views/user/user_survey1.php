					...
					if(!empty($info)) {
						foreach ($info as $row) {
							...
							echo '<label>Date of Birth:</label>
              					  <input type="text" class="form-control" name="dob" value="'.date("F d, Y", strtotime($row->dob)).'" disabled><br>';
							...
							echo '<label>Email: <b style="color:red;">**<i><small>This will also be used in recovering your password</i></small></b></label>';							
							echo form_input('email',$row->email,'class="form-control" type="email" placeholder="Email Address" required');
							echo '<br>';
							echo '<hr>';
