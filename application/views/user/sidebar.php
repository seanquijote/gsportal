...
<div class="lowerdiv"><p style="padding-top: 25%; text-align: center;"><a href="<?php echo base_url('user/profile'); ?>" style="text-decoration:none; font-weight:bold; font-size: 1em;"><?php echo $firstname.' '.$lastname;?></a></p></div>
<div class="lowernavdiv">
	...
	<?php
		if(!empty($notif)) {
			...
			echo '<br><br><a href="'.base_url('user/notifications').'" class="btn btn-success" style="color: white;"><i class="glyphicon glyphicon-bell"></i>&nbsp; <strong>View</strong> all notifications</a>';
